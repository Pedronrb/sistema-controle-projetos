...
- Create Angular project with ng: `ng new sistemadecontrole.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`sistemadecontrole.client.esproj`).
